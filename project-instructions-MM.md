...
## Language policy
- Use concise English for project instructions, technical documentation, code, identifiers, comments, tests, commit messages, and internal task artifacts.
- Always respond to the user in Spanish unless the user explicitly requests another language.
- Keep `README.md`, Demo Day materials, and business-facing content in Spanish.
- Preserve exact names, quotations, legal terms, and source-language text when accuracy requires it.
- Do not translate the same content into both languages unless requested.
