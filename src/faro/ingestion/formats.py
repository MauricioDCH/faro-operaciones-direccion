...
_CAPABILITIES = (
    ...
    FormatCapability(InputFormat.JSON, (".json",), ("application/json",), "phase_1", CapabilityStatus.PLANNED, "json_records", "Versioned JSON documents or batches"),
    FormatCapability(InputFormat.NDJSON, (".ndjson", ".jsonl"), ("application/x-ndjson", "application/jsonl"), "phase_1", CapabilityStatus.PLANNED, "json_records", "Newline-delimited JSON records"),
